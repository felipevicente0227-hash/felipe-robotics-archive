# 2023 Australia Champion — Mechanical Crank System
...
**Hardware disassembled — the behaviour described here is documented from the build photographs in this folder, not from a live re-test.** There is no video demo for this project,the programs are stored in a binary block-editor format, and can be opened using the studuino bit program listed above 
